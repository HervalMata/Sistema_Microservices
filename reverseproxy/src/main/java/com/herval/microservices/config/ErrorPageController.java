...
public class ErrorPageController extends AbstractErrorController {
    ...
    public void error(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        LOG.info("ERROR-PAGE:{}, IP:{}:{}, MESSAGE: {}, QUERY:{}", response.getStatus(), request.getRemoteAddr(),
                request.getRemotePort(), errorAttributes.get("message"), request.getAttribute("javax.servlet.error.request_uri"));
